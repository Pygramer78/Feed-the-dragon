...
pg.display.set_caption("Alimenta al dragon")
# Set FPS and clock
FPS = 60
clock = pg.time.Clock()
# Set game values
...
# Set text
score_text = font.render("Puntos: " + str(score), True, green, dark_green)
score_rect = score_text.get_rect()
score_rect.topleft = (10, 10)

title_text = font.render("Alimenta al dragon", True, green, black)
title_rect = title_text.get_rect()
title_rect.centerx = window_width // 2
title_rect.y = 10

lives_text = font.render("Vidas: " + str(player_lives), True, green, dark_green)
